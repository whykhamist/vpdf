import { defineComponent as h, defineAsyncComponent as w, createElementBlock as b, openBlock as v, createElementVNode as k, createCommentVNode as j, Fragment as y, renderList as z, createBlock as q, unref as T } from "vue";
function E(p) {
...
var U = F();
const C = /* @__PURE__ */ E(U);
var B = Object.defineProperty, P = (p, t, l) => t in p ? B(p, t, { enumerable: !0, configurable: !0, writable: !0, value: l }) : p[t] = l, c = (p, t, l) => P(p, typeof t != "symbol" ? t + "" : t, l);
class R {
  constructor(t, l) {
    c(this, "db"), c(this, "EXTRACT_TYPE_REGEXP"), c(this, "TEXT_TYPE_REGEXP"), c(this, "EXTRACT_EXT_REGEXP"), c(this, "types"), c(this, "extensions"), c(this, "typeSets"), c(this, "extname", (a) => {
      const e = this.EXTRACT_EXT_REGEXP.exec(a);
      return e == null ? "" : `.${e[1]}`;
    }), c(this, "extractExtension", (a) => !a || typeof a != "string" ? !1 : this.extname("x." + a).toLowerCase().substring(1) || !1), c(this, "populateMaps", () => {
      const a = ["nginx", "apache", void 0, "iana"], e = this.db, s = this.types, d = this.typeSets;
      Object.keys(e).forEach((i) => {
        const r = e[i], n = r.extensions;
        if (!(!n || !n.length)) {
          Object.assign(this.extensions, { [i]: n });
          for (let o = 0; o < n.length; o++) {
            const u = n[o];
            if (d[n[o]] ? d[n[o]].push(i) : d[n[o]] = [i], s[u]) {
              const m = a.indexOf(e[s[u]].source), x = a.indexOf(r.source);
              if (s[u] !== "application/octet-stream" && (m > x || m === x && s[u].substr(0, 12) === "application/"))
                continue;
            }
            s[u] = i;
          }
      ...
      if (!a || typeof a != "string")
        return !1;
      const e = this.EXTRACT_TYPE_REGEXP.exec(a), s = e && this.db[e[1].toLowerCase()];
      return s && s.charset ? s.charset : e && this.TEXT_TYPE_REGEXP.test(e[1]) ? "UTF-8" : !1;
    }), c(this, "getContentType", (a) => {
      if (!a || typeof a != "string")
        return !1;
      let e = a.indexOf("/") === -1 ? this.getMime(a) : a;
      if (!e)
        return !1;
      if (e.indexOf("charset") === -1) {
        const s = this.getCharset(e);
        s && (e += "; charset=" + s.toLowerCase());
      }
      return e;
    }), c(this, "getExtension", (a) => {
      if (!a || typeof a != "string")
        return !1;
      const e = this.EXTRACT_TYPE_REGEXP.exec(a), s = e && this.extensions[e[1].toLowerCase()];
      return !s || !s.length ? !1 : s[0];
    }), c(this, "getMime", (a) => {
      if (!a || typeof a != "string")
        return !1;
      const e = this.extname("x." + a).toLowerCase().substring(1);
      return e && this.types[e] || !1;
    }), c(this, "getMimes", (a) => {
      const e = this.extractExtension(a);
      return e && this.typeSets[e] || !1;
    }), this.db = t, l && this.setExtNameFn(l), this.EXTRACT_TYPE_REGEXP = /^\s*([^;\s]*)(?:;|\s|$)/, this.TEXT_TYPE_REGEXP = /^text\//i, this.EXTRACT_EXT_REGEXP = /^.+\.([^.]+)$/, this.types = /* @__PURE__ */ Object.create(null), this.extensions = /* @__PURE__ */ Object.create(null), this.typeSets = /* @__PURE__ */ Object.create(null), this.populateMaps();
  }
  /**
...
const X = new R(C), {
  ...
  getMime: O,
  getMimes: Z
} = X, M = { class: "flex max-h-full flex-col gap-0.5 py-1" }, G = { class: "min-h-0 flex-auto overflow-auto" }, A = {
  key: 0,
  ...
  setup(p) {
    const t = w(
      ...
      const r = s(
        l.attachments[i].content,
        O(i)
      );
      e(r, i);
    }, e = (i, r) => {
      const n = window.URL.createObjectURL(i), o = document.createElement("a");
      o.href = n, o.download = r, o.click(), window.URL.revokeObjectURL(n);
    }, s = (i, r) => new Blob([i], {
      type: r
    }), d = (i, r = !1, n = 1) => {
      const o = r ? 1e3 : 1024;
      if (Math.abs(i) < o)
        return i + " B";
      const u = r ? ["kB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"] : ["KiB", "MiB", "GiB", "TiB", "PiB", "EiB", "ZiB", "YiB"];
      let m = -1;
      const x = 10 ** n;
      do
        i /= o, ++m;
      while (Math.round(Math.abs(i) * x) / x >= o && m < u.length - 1);
      return i.toFixed(n) + " " + u[m];
    };
    return (i, r) => (v(), b("div", M, [
      k("div", G, [
        !i.attachments || Object.keys(i.attachments).length <= 0 ? (v(), b("div", A, " No Attachments ")) : j("", !0),
        (v(!0), b(y, null, z(i.attachments, (n, o) => (v(), q(T(t), {
          key: n.filename,
          attachment: n,
          size: d(n.content.length),
          onClick: (u) => a(o),
          class: "mb-0.5"
        }, null, 8, ["attachment", "size", "onClick"]))), 128))
      ])
    ]));
  }
...
//# sourceMappingURL=DYig_lRG.js.map
